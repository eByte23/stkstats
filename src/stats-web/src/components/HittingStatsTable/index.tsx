...
type HittingStatsTableProps = { players: Player[], showNameColumn?: boolean }

export const HittingStatsTable = ({ players, showNameColumn }: HittingStatsTableProps) => {
    return <table className="table-auto">
        <thead>
            <tr>
                {showNameColumn && (<th className="px-3 text-left">Name</th>)}
                <th className="">PA</th>
                <th className="">AB</th>
                <th className="">H</th>
                <th className="">TB</th>
